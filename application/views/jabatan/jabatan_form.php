...
<div class="row">
	<div class="col-md-12">
	    ...
	    <tr><td>Kode Jabatan <?php echo form_error('kode_jabatan') ?></td><td><input type="text" class="form-control" name="kode_jabatan" id="kode_jabatan" placeholder="Kode Jabatan" value="<?php echo $kode_jabatan; ?>" /></td></tr>
	    ...
	    <a href="<?php echo site_url('jabatan') ?>" class="btn btn-info"><i class="fa fa-undo"></i> Kembali</a></td></tr>
</thead>
	</table></form>        </div>
</div>
</div>
