        ...
        <div id="header" class="header navbar navbar-default navbar-fixed-top">
            ...
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    <a href="<?= base_url() ?>dashboard" class="navbar-brand"><span class="navbar-logo"></span> SI
                        Komoditas</a>
        ...
        <div id="sidebar" class="sidebar">
            ...
            <div data-scrollbar="true" data-height="100%">
                ...
                <ul class="nav">
                    ...
                    <li><a href="<?= base_url() ?>dashboard"><i class="fa fa-list"></i> <span>Data Komoditas</span></a>
                    </li>
                    <li class="has-sub">
                        <a href="javascript:;">
                        ...
                        <ul class="sub-menu">
                            ...
                            <li><a href="<?= base_url() ?>kategori">Kategori Indormasi</a></li>
                        </ul>
                    </li>
                    <li class="has-sub">
                        <a href="javascript:;">
                        ...
                        <ul class="sub-menu">
                            <li><a href="<?= base_url() ?>user">User Dinas</a></li>
                            <li><a href="<?= base_url() ?>backup">Dinas Terdaftar</a></li>
                        </ul>
                    </li>
